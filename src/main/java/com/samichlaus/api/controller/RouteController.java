...
public class RouteController {
  ...
  @PutMapping("{id}")
  public ResponseEntity<Route> updateRoute(@PathVariable("id") UUID uuid, @Valid RouteDto routeDto)
  ...
  @PatchMapping("")
  @Transactional
  public ResponseEntity<HttpStatus> updateRoute(@Valid @RequestBody RoutePatchDto routePatchDto)
      throws ResourceNotFoundException {
  ...
  @PatchMapping("many")
  @Transactional
  public ResponseEntity<HttpStatus> updateManyRoutes(
      @Valid @RequestBody List<RoutePatchDto> routePatchDtos) throws ResourceNotFoundException {
  ...
  public ResponseEntity<Route> createRoute(
      @Valid @RequestBody RouteDto routeDto, Authentication authentication)
      throws ResourceNotFoundException {
  ...
  @DeleteMapping("{id}")
  @Transactional
  public ResponseEntity<HttpStatus> deleteRoute(@PathVariable("id") UUID uuid)
