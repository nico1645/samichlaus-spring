...
public class Constants {
  private static final HashMap<Integer, Integer> CHILDREN_MAP = new HashMap<>();
  private static final HashMap<Integer, Integer> SENIOR_MAP = new HashMap<>();

  public static final List<Double> DEPOT_LAT_LNG = List.of(46.990265, 8.310657);
  private static final int DEFAULT_MAX_WAIT_TIME = 50;
